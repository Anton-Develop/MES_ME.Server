...
public sealed class FurnaceController : ControllerBase
{
    ...
    private async Task<HeatingReportDto> BuildReport(HeatingSession session, CancellationToken ct)
    {
        ...
        return new HeatingReportDto
        {
            ...
            F3Min = session.F3Min,
            F4Min = session.F4Min,
            AvgZ1_1 = session.AvgZ1_1,
            AvgZ1_2 = session.AvgZ1_2,
            AvgZ1_3 = session.AvgZ1_3,
            AvgZ1_4 = session.AvgZ1_4,
            AvgZ2_1 = session.AvgZ2_1,
            AvgZ2_2 = session.AvgZ2_2,
            AvgZ2_3 = session.AvgZ2_3,
            AvgZ2_4 = session.AvgZ2_4,
