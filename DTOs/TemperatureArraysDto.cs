namespace MES_ME.Server.DTOs
{
    public class TemperatureArraysDto
    {
        ...
        public List<float?> Z1_4 { get; set; } = new();
        public List<float?> Z2_1 { get; set; } = new();
        public List<float?> Z2_2 { get; set; } = new();
        public List<float?> Z2_3 { get; set; } = new();
        public List<float?> Z2_4 { get; set; } = new();
        public List<float?> Z3_1 { get; set; } = new();
        public List<float?> Z3_2 { get; set; } = new();
        public List<float?> Z3_3 { get; set; } = new();
        public List<float?> Z3_4 { get; set; } = new();
        public List<float?> Z4_1 { get; set; } = new();
