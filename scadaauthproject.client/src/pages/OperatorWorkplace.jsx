    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '70px 1fr 70px', gap: 6, marginBottom: 6 }}>
                {c(7, 'h8')}
                <div style={{
                    height: 45, border: `2px dashed ${C.panelBd}`, borderRadius: 6, opacity: 0.3,
                    display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}>
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <div>
                    <div style={{ color: C.dim, fontSize: 10 }}>МАРОК</div>
                    <div style={{ color: C.yellow, fontWeight: 700, fontSize: 18 }}>{grades.size}</div>
                </div>
                <div style={{ flex: 1, textAlign: 'right' }}>
                    ...
                    <div style={{ fontFamily: 'monospace', fontSize: 13, fontWeight: 700, color: C.accent }}>
                        {lastSheet ? `${lastSheet.sheet?.meltNumber}/${lastSheet.sheet?.batchNumber}/${lastSheet.sheet?.packNumber}/${lastSheet.sheet?.steelGrade}/${lastSheet.sheet?.sheetNumber}` : '—'}
                    </div>
                    {lastSheet?.sheet?.steelGrade && (
